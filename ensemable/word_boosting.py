...
batch_size = 128
model_name = "word_cnn_boosting"
trainable_layer = ["embedding"]
train_batch_generator = word_cnn_train_batch_generator

logging.info("Load Val Data")
val_word_seq = pickle.load(open(Config.cache_dir+"/g_val_word_seq_{}_{}.pkl".format(Config.title_word_seq_maxlen, Config.descr_word_seq_maxlen), "rb"))
...
for layer in range(10):
    ...
    model = get_textcnn(Config.title_word_seq_maxlen, Config.descr_word_seq_maxlen, word_embed_weight)
...
test_word_seq = pickle.load(open(Config.cache_dir+"/g_test_word_seq_{}_{}.pkl".format(Config.title_word_seq_maxlen, Config.descr_word_seq_maxlen), "rb"))
test_seq = test_word_seq
